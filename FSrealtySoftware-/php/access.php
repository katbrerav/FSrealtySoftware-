...
<div id="occupiedRequests" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Please select up to two days and times that you will like to show the property. If the first date provided is not confirmed with the tenants, we will request to show on the second date. <br><br>
        //timePicker here<br> //timePicker here<br><br> 
